namespace Mutuales2020.Utilidades
{
    ...
    public partial class FrmLiquidarIntereses : Form
    {
        public FrmLiquidarIntereses()
        {
            InitializeComponent();
        }

        private void FrmLiquidarIntereses_Load(object sender, EventArgs e)
        {
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            { 
                case "01":
                    bitExiste = new blAhorrosIntereses().gmtdConsultarAñoyTrimestreAhorrosOrdinarios(Convert.ToInt32(this.cboAño.Text), Convert.ToInt32(this.cboTrimestre.Text));
                    if (new blAhorrosIntereses().gmtdConsultarAñoyTrimestreAhorrosOrdinarios(Convert.ToInt32(this.cboAño.Text), Convert.ToInt32(this.cboTrimestre.Text)))
        ...
        private void gmtdMostrarReporte(string tstrTipo)
        {
            ...
            ds = propiedades.ejecutarSp(lstParameters, "spLiquidarIntereses");
            ...
            parametroReporte = new ReportParameter("Titulo", "Liquidar Intereses");
            lstParametros.Add(parametroReporte);
            ...
            //rptCreditos.LocalReport.ReportPath = @"D:\Andres Tabares\Desarrollos\Aplicaciones Personales\Exequial2010\Mutuales2020\Creditos\Reportes\rptCreditos.rdlc";
