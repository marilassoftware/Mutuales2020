namespace Mutuales2020.Ahorros
{
    ...
    public partial class frmAhorrosNatilleraEscolar : Form
    {
        public frmAhorrosNatilleraEscolar()
        {
            InitializeComponent();
        }
        
        #region metodos
        private static frmAhorrosNatilleraEscolar form = null;
        public static frmAhorrosNatilleraEscolar DefInstance
        {
            get
            {
                if (form == null || form.IsDisposed)
                {
                    form = new frmAhorrosNatilleraEscolar();
                }
                else
                {
                    form.BringToFront();
        ...
        private void pmtdCargarGrid()
        {
            if (propiedades.bitConsultar == true)
            {
                ...
                this.dgvAhorrosNavideños.DataSource = new blAhorrosNatilleraEscolar().gmtdConsultarTodos();
            }
        }
        ...
        private tblAhorrosNatilleraEscolar crearObj()
        {
            tblAhorrosNatilleraEscolar ahorros = new tblAhorrosNatilleraEscolar();
        ...
        private void frmAhorrosnatilleraEscolar_Load(object sender, EventArgs e)
        {
            this.gmtdPermisosBotones();
            this.pmtdCargarGrid();
            this.txtCuotas.Text = "38";
        }
        ...
        {
            this.pmtdMensaje(new blAhorrosNatilleraEscolar().gmtdInsertar(crearObj()), "Ahorro Natillera Escolar");
            this.pmtdCargarGrid();
        }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.pmtdMensaje(new blAhorrosNatilleraEscolar().gmtdEliminar(crearObj()), "Ahorro Natillera Escolar");
            }
            this.pmtdCargarGrid();
        ...
        private void frmAhorrosnatilleraEscolar_FormClosed(object sender, FormClosedEventArgs e)
        {
            propiedades.strFormActivo = "Principal";
        }
