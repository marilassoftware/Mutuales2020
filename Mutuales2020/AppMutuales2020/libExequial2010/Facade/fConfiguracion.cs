namespace libMutuales2020.Facade
{
    ...
    public class fConfiguracion
    {
        ...
        {
            return new blConfiguracion().gmtdConsultaConfiguracion();
        }
        ...
        {
            return new blConfiguracion().gmtdCapturarFechadelServidor();
        }
        ...
        {
            return new blConfiguracion().gmtdRespaldarBasedeDatos(tstrCadena);
        }
        ...
        {
            return new blConfiguracion().gmtdConsultarTodoslosVideos();
        }
        ...
        {
            return new blConfiguracion().gmtdDeshabilitarSocios();
        }
        ...
        {
            return new blConfiguracion().gmtdInsertarNumeroRifa(tobjRifa, tstrTipo);
        }
        ...
        {
            return new blConfiguracion().gmtdConsultarSociosPrestamosparaRifa(tobjRifa, tstrTipo);
        }
        ...
        {
            return new blConfiguracion().gmtdConsultarPeriodos();
        }
        ...
        {
            return new blConfiguracion().montoenLetras(tstrMonto);
        }
        ...
        {
            return new blConfiguracion().gmtdConsultarQuincenas(tintAño);
        }
    }
}
