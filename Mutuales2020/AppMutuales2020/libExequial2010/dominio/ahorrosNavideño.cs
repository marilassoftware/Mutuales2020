...
namespace libMutuales2020.dominio
{
    ...
    public partial class tblAhorrosNavideno
    {
        public tblLogdeActividade log { get; set; }

        public string strFormulario { get; set; }

        public List<tblAhorrosNavidenoDetalle> lstMeses { get; set; }
    ...
    public class LiquidacionAhorroNavideno
    {
